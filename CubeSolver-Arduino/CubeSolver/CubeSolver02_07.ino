...
void setup() {
    ...
    //lcd.begin(16, 2);  turn sequence to lcd
   // lcd.setCursor(16, 1);
   // lcd.autoscroll();
...
void checkmessage()
{
  if (message == 'Z')
  {
      ...
      case 'B':
        stepper_Y.rotate(QT);delay(1000);
        break;

      case 'C':
        stepper_Z.rotate(QT);delay(1000);
        break;

      case 'D':
        stepper_E0.rotate(QT);delay(1000);
        break;

      case 'E':
        stepper_E1.rotate(QT);delay(1000);
        break;

      case 'F':
        stepper_E2.rotate(QT);delay(1000);
        break;

      case 'G':
        stepper_X.rotate(NQT);delay(1000);
        break;
        
      case 'H':
        stepper_Y.rotate(NQT);delay(1000);
        break;

      case 'I':
        stepper_Z.rotate(NQT);delay(1000);
        break;

      case 'J':
        stepper_E0.rotate(NQT);delay(1000);
        break;

      case 'K':
        stepper_E1.rotate(NQT);delay(1000);
        break;

      case 'L':
        stepper_E2.rotate(NQT);delay(1000);
        break;

      case 'M':
        stepper_X.rotate(HT);delay(1000);
        break;
        
      case 'N':
        stepper_Y.rotate(HT);delay(1000);
        break;

      case 'O':
        stepper_Z.rotate(HT);delay(1000);
        break;

      case 'P':
        stepper_E0.rotate(HT);delay(1000);
        break;

      case 'Q':
        stepper_E1.rotate(HT);delay(1000);
        break;

      case 'R':
        stepper_E2.rotate(HT);delay(1000);
        break;
  ...
  else
  {
    ...
    face = message;
    delay(5);
    //lcd.print(face); turn sequence to lcd
    Serial.write(face);
