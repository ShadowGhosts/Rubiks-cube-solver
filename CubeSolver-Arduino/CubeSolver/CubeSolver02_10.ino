...
#define RPM 50 //Sets speed of the steppers
...
#define sd 1000 //Delay used inbetween every stepper motor turn so LCD can keep up (sd = stepper delay)
...
void setup() {
    ...
    stepper_X.enable(); //Locks the steppers
